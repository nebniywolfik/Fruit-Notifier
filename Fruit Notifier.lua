...
local function enableNotifier(fruit)
	...
	while fruit_alive and workspace_connection do
		if (lang == "pt-br") then
			...
			notifier.Text = "FRUIT DETECTED: " .. math.floor((local_player.Character:WaitForChild("UpperTorso").Position - fruit_child.Position).Magnitude * 0.15) .. "m away"
		end
